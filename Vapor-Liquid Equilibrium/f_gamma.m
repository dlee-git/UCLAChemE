function[f]=f_gamma(T,x0)

x = x0;
x(2)=x0(1);
x(1)=x0(2);

%System: Ethanol, Water, Acetone, Acetic Acid
%----------------------------------------------
...
% m\k |   1     1         5         7       9        20
% -------------------------------------------------
% 1   |   0      0       986.50   1318.0   476.40    663.50
% 1   |   0      0       986.50   1318.0   476.40    663.50
% 5   | 156.40  156.40     0      353.50   84.00     199.00        
% 7   | 300.00  300.00  -229.10    0      -195.40    -14.090
% 9   | 26.76    26.76   164.50   472.50     0       669.40
% 20  | 315.30  315.30  -151.00   -66.170 -297.80       0
